"""Flask Chatbot Backend — serves the frontend and API endpoints.

After the user completes all chatbot steps, their selections and custom
message are sent to OpenAI for analysis. The LLM's response is returned
to the frontend and displayed in the chat window.
"""
